 ...
 */
package com.otaserver.client.viewflow;
...
public class ViewFlow extends AdapterView<Adapter> {
    ...
    private  boolean showPanelBtn = false ;
//    private Panel mPanel = null ;
//    private View HandlerBtn = null ;
//    private Animation appear_alpha = null ;
//    private Animation disappear_alpha = null ;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            Log.i("ViewFlow", "xDiff:" + xDiff + "  mTouchSlop:  "+mTouchSlop+" xMoved: " + xMoved);
            if (xMoved) {
            ...
            if (mTouchState == TOUCH_STATE_SCROLLING) {
                ...
                if (deltaX < 0) {
                    ...
                    Log.i("ViewFlow", "getChildAt(getChildCount() - 1).getRight(): " + getChildAt(getChildCount() - 1).getRight());
                    Log.i("ViewFlow", "deltaX: " + deltaX + " availableToScroll: " + availableToScroll + " scrollX: " + scrollX + " getWidth(): " + getWidth());
